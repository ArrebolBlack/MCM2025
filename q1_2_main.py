...
# 初始化 W&B
wandb.init(project="MCM2025Q1", entity="tbsi", name="APINet HuberLoss")
...
# 训练和评估
train(model, train_loader, criterion, optimizer, num_epochs=10, device='cuda' if torch.cuda.is_available() else 'cpu', save_path="checkpoints/", scheduler=scheduler, task_type="regression")
